...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Advanced: How to Realize Daily-Teaching Task under GNU/Linux}
...
\section{Use GNU/Linux Under Windows Platform: CygWin}
...
\end{enumerate}
\section{GNU/Linux and Its Distributions}
