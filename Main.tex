...
\makeatletter\renewcommand{\verbatim@font}{\footnotesize \color{blue}} \makeatletter%修改verbatim环境格式
 %生成章节中文名和盒子
...
{\color{white}{\vspace*{10mm}
\begin{center}
\doublebox{\parbox{18cm}{\begin{center}		
							\textsf{\fbox{\Huge \textsf{\textbf{电教委员（不）完全技术指南（简体中文）}}\normalsize}\\\vspace*{5mm}\large 作者：YuZJ Lab \\\vspace*{5mm}\large 编译日期：\today\normalsize}	
						\end{center}}}
\end{center}}}
\vspace*{25mm}
\shadowbox{\parbox[t]{8cm}{“工欲善其事，必先利其器”，对于我们来说，掌握如何高效率地使用计算机是十分重要的。为了方便信息化教学的开展，我结合自己的工作经历，不自量力地“年来著书一种”，为希望掌握关于如何高效地使用教室计算机的初级和高级技巧的电教委员或者其余希望提高计算机技能的教师、学生及其他教职人员编写了这份文件。}}
\end{titlepage}
\begin{center}
	\Huge 试行本 \normalsize
\end{center}
