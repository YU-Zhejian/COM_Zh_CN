...
一对PS/2接口。用于鼠标与键盘。
\begin{center}
	\includegraphics{pic/PS2}\includegraphics[scale=0.15]{pic/PS2L}
\end{center}\par
...
\begin{center}
	\includegraphics{pic/RJ}\includegraphics[scale=0.1]{pic/RJL}
\end{center}\par
2个3.5mm TRS接口。
\begin{center}
...
\begin{center}
	\includegraphics[scale=0.2]{pic/win10setup1}
\end{center} \par
...
\begin{center}
	\includegraphics[scale=0.2]{pic/win10setup8}
\end{center}\par
现在你可以插上网线了。
...
\begin{center}
	\includegraphics[scale=0.25]{pic/sg1}
\end{center}\par
单击“OK”，你将得到主界面：
\begin{center}
	\includegraphics[scale=0.3]{pic/sg2}
\end{center}\par
现在假设我们需要备份Z盘，我们就应该在这个地方单击一下：
\begin{center}
	\includegraphics[scale=0.3]{pic/sg3}
\end{center}\par
选择设备和分区（这个可以根据硬盘生产商和容量鉴别）：
\begin{center}
	\includegraphics[scale=0.3]{pic/sg4}	\includegraphics[scale=0.3]{pic/sg5}
\end{center}\par
选择保存位置：
\begin{center}
	\includegraphics[scale=0.35]{pic/sg6}
\end{center}\par
是否压缩（这个按照自己的要求选择，压缩高耗时长）：
\begin{center}
	\includegraphics[scale=0.3]{pic/sg7}
\end{center}\par
再进行一次确认就开始操作：
\begin{center}
	\includegraphics[scale=0.3]{pic/sg8}
\end{center}\par
...
\begin{center}
\includegraphics[scale=0.25]{pic/kj1}
\end{center} \par
一个窗口上面又有许多独立的组成要素，我们把它称为“控件”。常见的控件如下：
\begin{center}
	\includegraphics[scale=0.35]{pic/kj2}\\\includegraphics{pic/kj3}
\end{center} \par
...
\begin{center}
	\includegraphics[scale=0.25]{pic/htopen1}  	\includegraphics[scale=0.25]{pic/htopen2}
\end{center} 
\subsubsection{回收站以及Windows系统删除文件机制}
...
\begin{center}
\includegraphics[scale=0.25]{pic/avtest1}\includegraphics[scale=0.25]{pic/avtest2}
\includegraphics[scale=0.25]{pic/avtest3}
\end{center} \par
...
\begin{center}
	\includegraphics[scale=0.2]{pic/avi1}	\includegraphics[scale=0.2]{pic/avi2}\\
	\includegraphics[scale=0.37]{pic/avi3}
\end{center} \par
4.火绒安全软件5.0
...
\begin{center}
	\includegraphics[scale=0.3]{pic/huorong}
\end{center} \par
5.腾讯电脑管家V13\par
...
\begin{center}
	\includegraphics[scale=0.25]{pic/tsav}
\end{center} \par
6.360安全卫士12\par
...
\begin{center}
	\includegraphics[scale=0.25]{pic/360}
\end{center} \par
\begin{enumerate}
...
\begin{center}
	\includegraphics[scale=0.35]{pic/vt}
\end{center} \par
不过似乎有些反病毒引擎性能确实不太好（下图是微信2.6.8.65安装包和Ghost115）（欧洲著名反病毒软件Panda曾经将自己的病毒库当成病毒杀掉）。
\begin{center}
	\includegraphics[scale=0.35]{pic/vt2}\\	\includegraphics[scale=0.35]{pic/vt3}
\end{center} 
\subsection{压缩/解压缩}
...
\begin{center}
	\includegraphics[scale=0.35]{pic/7zipinst}
\end{center} \par
...
\begin{center}
	\includegraphics[scale=0.35]{pic/7zopt.PNG}
\end{center} \par
...
\begin{center}
\includegraphics[scale=0.27]{pic/ziprate.PNG}	
\end{center} \par
...
\begin{center}
\includegraphics[scale=0.24]{pic/vlc.png}	
\end{center} \par
...
自由软件。
\begin{center}
	\includegraphics[scale=0.25]{pic/npp.png}
\end{center}
\par
一个支持语法高亮\footnote{为数不多的能正确高亮NSIS语法的编辑器，但不得不说似乎对\LaTeX 语法的支持似乎不是特别好}，正则表达式搜索、跨文件搜索、多光标、多文件同时编辑等功能的编辑器，能够正确地识别多种断行格式。推荐一般能力的电教委员使用。下载：\url{https://notepad-plus-plus.org/}（最后连接于2019年8月9日20:35:34，网速较慢）。
...
\begin{center}
	...
	\includegraphics[scale=0.17]{pic/wdc}	\includegraphics[scale=0.15]{pic/wrc}
\end{center}
\subsection{CCleaner}
...
\begin{center}
	\includegraphics[scale=0.4]{pic/pap}
\end{center}