...
\begin{center}
	\includegraphics[scale=0.1]{pic/A-USB-1}\includegraphics[scale=0.1]{pic/A-USB-2}
\end{center}\par
...
\begin{center}
\includegraphics[scale=0.3]{pic/Micro-USB-B-1}\includegraphics[scale=0.2]{pic/Micro-USB-B-2}
\end{center}\par
...
\begin{center}
	\includegraphics[scale=0.16]{pic/KB1}\\\includegraphics[scale=0.16]{pic/KB2}
\end{center}\par
